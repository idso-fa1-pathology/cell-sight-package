...
def run_inference(file_paths, weights_path='backend/models/weights/best.pt'):
    ...
    for file_path in file_paths:
        ...
        prediction_results = model.predict(source=file_path, save=True, imgsz=640, max_det=3000, conf=0.1, show_labels=False, save_txt=True, project=save_dir, name=file_name)
